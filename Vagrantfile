Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "wordpress1"  
  #Имя в Vagrant Status 
  config.vm.define "WordpressDevTools1"
  ...
  config.vm.provision "nfs-not-bags", type: "shell", run: "always" do |s|
    ...
    s.inline = "sudo mount 192.168.71.1:$1/site /var/www/site;
                sudo mount 192.168.71.1:$1/config /home/config;"
    s.args   = [vagrant_root]
  end
