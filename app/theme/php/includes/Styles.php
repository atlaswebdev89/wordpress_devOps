...
function register_theme_styles () {
    ...
    wp_register_style('fonts', URL_THEMES.'/assets/css/fonts.min.css', array(), $theme_version);
...
function wp_head_preload_fonts() {
    echo
         '<link rel="preload" href="' . get_template_directory_uri() . '/assets/fonts/Lato-Regular.ttf" as="font" crossorigin>'
        .'<link rel="preload" href="' . get_template_directory_uri() . '/assets/fonts/Lato-Bold.ttf" as="font" crossorigin>'
    ;
}
